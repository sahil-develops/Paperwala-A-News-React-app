...
<Routes>
<Route exact strict path="/"   element={<News setProgress={setProgress}   key="general" pageSize={9} country="us" category="general"/>}/>
...
<Route exact path="/foreign"  element={<News setProgress={setProgress}   key="foreign" pageSize={9} country="us" />}/>
</Routes>
</div>
    )
